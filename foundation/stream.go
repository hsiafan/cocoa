...
func (sc _StreamClass) Alloc() Stream {
	rv := objc.CallMethod[Stream](sc, "alloc")
	return rv
}

func (sc _StreamClass) New() Stream {
	rv := objc.CallMethod[Stream](sc, "new")
	rv.Autorelease()
	return rv
}
...
func (s_ Stream) Init() Stream {
	rv := objc.CallMethod[Stream](s_, "init")
	return rv
}

func (s_ Stream) PropertyForKey(key StreamPropertyKey) objc.Object {
	rv := objc.CallMethod[objc.Object](s_, "propertyForKey:", key)
	return rv
}

func (s_ Stream) SetProperty_ForKey(property objc.IObject, key StreamPropertyKey) bool {
	rv := objc.CallMethod[bool](s_, "setProperty:forKey:", property, key)
	return rv
}

func (s_ Stream) Open() {
	objc.CallMethod[objc.Void](s_, "open")
}

func (s_ Stream) Close() {
	objc.CallMethod[objc.Void](s_, "close")
}

func (s_ Stream) ScheduleInRunLoop_ForMode(aRunLoop IRunLoop, mode RunLoopMode) {
	objc.CallMethod[objc.Void](s_, "scheduleInRunLoop:forMode:", aRunLoop, mode)
}

func (s_ Stream) RemoveFromRunLoop_ForMode(aRunLoop IRunLoop, mode RunLoopMode) {
	objc.CallMethod[objc.Void](s_, "removeFromRunLoop:forMode:", aRunLoop, mode)
}
...
func (sc _StreamClass) GetBoundStreamsWithBufferSize_InputStream_OutputStream(bufferSize uint, inputStream *InputStream, outputStream *OutputStream) {
	objc.CallMethod[objc.Void](sc, "getBoundStreamsWithBufferSize:inputStream:outputStream:", bufferSize, unsafe.Pointer(inputStream), unsafe.Pointer(outputStream))
}
...
func (sc _StreamClass) GetStreamsToHostWithName_Port_InputStream_OutputStream(hostname string, port int, inputStream *InputStream, outputStream *OutputStream) {
	objc.CallMethod[objc.Void](sc, "getStreamsToHostWithName:port:inputStream:outputStream:", hostname, port, unsafe.Pointer(inputStream), unsafe.Pointer(outputStream))
}

func (s_ Stream) Delegate() StreamDelegateWrapper {
	rv := objc.CallMethod[StreamDelegateWrapper](s_, "delegate")
	return rv
}
...
func (s_ Stream) StreamStatus() StreamStatus {
	rv := objc.CallMethod[StreamStatus](s_, "streamStatus")
	return rv
}

func (s_ Stream) StreamError() Error {
	rv := objc.CallMethod[Error](s_, "streamError")
	return rv
}

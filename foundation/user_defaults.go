...
func (u_ UserDefaults) Init() UserDefaults {
	rv := objc.CallMethod[UserDefaults](u_, "init")
	return rv
}

func (u_ UserDefaults) InitWithSuiteName(suitename string) UserDefaults {
	rv := objc.CallMethod[UserDefaults](u_, "initWithSuiteName:", suitename)
	return rv
}

func (uc _UserDefaultsClass) Alloc() UserDefaults {
	rv := objc.CallMethod[UserDefaults](uc, "alloc")
	return rv
}

func (uc _UserDefaultsClass) New() UserDefaults {
	rv := objc.CallMethod[UserDefaults](uc, "new")
	rv.Autorelease()
	return rv
}

...
func (f_ FileWrapper) InitWithURL_Options_Error(url IURL, options FileWrapperReadingOptions, outError *Error) FileWrapper {
	rv := objc.CallMethod[FileWrapper](f_, "initWithURL:options:error:", url, options, unsafe.Pointer(outError))
	return rv
}

func (f_ FileWrapper) InitDirectoryWithFileWrappers(childrenByPreferredName map[string]IFileWrapper) FileWrapper {
	rv := objc.CallMethod[FileWrapper](f_, "initDirectoryWithFileWrappers:", childrenByPreferredName)
	return rv
}

func (f_ FileWrapper) InitRegularFileWithContents(contents []byte) FileWrapper {
	rv := objc.CallMethod[FileWrapper](f_, "initRegularFileWithContents:", contents)
	return rv
}

func (f_ FileWrapper) InitSymbolicLinkWithDestinationURL(url IURL) FileWrapper {
	rv := objc.CallMethod[FileWrapper](f_, "initSymbolicLinkWithDestinationURL:", url)
	return rv
}

func (f_ FileWrapper) InitWithSerializedRepresentation(serializeRepresentation []byte) FileWrapper {
	rv := objc.CallMethod[FileWrapper](f_, "initWithSerializedRepresentation:", serializeRepresentation)
	return rv
}

func (fc _FileWrapperClass) Alloc() FileWrapper {
	rv := objc.CallMethod[FileWrapper](fc, "alloc")
	return rv
}

func (fc _FileWrapperClass) New() FileWrapper {
	rv := objc.CallMethod[FileWrapper](fc, "new")
	rv.Autorelease()
	return rv
}
...
func (f_ FileWrapper) WriteToURL_Options_OriginalContentsURL_Error(url IURL, options FileWrapperWritingOptions, originalContentsURL IURL, outError *Error) bool {
	rv := objc.CallMethod[bool](f_, "writeToURL:options:originalContentsURL:error:", url, options, originalContentsURL, unsafe.Pointer(outError))
	return rv
}

func (f_ FileWrapper) IsRegularFile() bool {
	rv := objc.CallMethod[bool](f_, "isRegularFile")
	return rv
}

func (f_ FileWrapper) IsDirectory() bool {
	rv := objc.CallMethod[bool](f_, "isDirectory")
	return rv
}

func (f_ FileWrapper) IsSymbolicLink() bool {
	rv := objc.CallMethod[bool](f_, "isSymbolicLink")
	return rv
}

func (f_ FileWrapper) FileWrappers() map[string]FileWrapper {
	rv := objc.CallMethod[map[string]FileWrapper](f_, "fileWrappers")
	return rv
}

func (f_ FileWrapper) SymbolicLinkDestinationURL() URL {
	rv := objc.CallMethod[URL](f_, "symbolicLinkDestinationURL")
	return rv
}

func (f_ FileWrapper) SerializedRepresentation() []byte {
	rv := objc.CallMethod[[]byte](f_, "serializedRepresentation")
	return rv
}

func (f_ FileWrapper) Filename() string {
	rv := objc.CallMethod[string](f_, "filename")
	return rv
}

func (f_ FileWrapper) SetFilename(value string) {
	objc.CallMethod[objc.Void](f_, "setFilename:", value)
}

func (f_ FileWrapper) PreferredFilename() string {
	rv := objc.CallMethod[string](f_, "preferredFilename")
	return rv
}

func (f_ FileWrapper) SetPreferredFilename(value string) {
	objc.CallMethod[objc.Void](f_, "setPreferredFilename:", value)
}

func (f_ FileWrapper) FileAttributes() map[string]objc.Object {
	rv := objc.CallMethod[map[string]objc.Object](f_, "fileAttributes")
	return rv
}

func (f_ FileWrapper) SetFileAttributes(value map[string]objc.IObject) {
	objc.CallMethod[objc.Void](f_, "setFileAttributes:", value)
}

func (f_ FileWrapper) RegularFileContents() []byte {
	rv := objc.CallMethod[[]byte](f_, "regularFileContents")
	return rv
}

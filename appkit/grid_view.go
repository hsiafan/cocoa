...
func (gc _GridViewClass) GridViewWithNumberOfColumns_Rows(columnCount int, rowCount int) GridView {
	rv := objc.CallMethod[GridView](gc, "gridViewWithNumberOfColumns:rows:", columnCount, rowCount)
	return rv
}

func (gc _GridViewClass) GridViewWithViews(rows [][]IView) GridView {
	rv := objc.CallMethod[GridView](gc, "gridViewWithViews:", rows)
	return rv
}

func (g_ GridView) InitWithFrame(frameRect foundation.Rect) GridView {
	rv := objc.CallMethod[GridView](g_, "initWithFrame:", frameRect)
	return rv
}

func (g_ GridView) Init() GridView {
	rv := objc.CallMethod[GridView](g_, "init")
	return rv
}

func (gc _GridViewClass) Alloc() GridView {
	rv := objc.CallMethod[GridView](gc, "alloc")
	return rv
}

func (gc _GridViewClass) New() GridView {
	rv := objc.CallMethod[GridView](gc, "new")
	rv.Autorelease()
	return rv
}
...
func (g_ GridView) IndexOfColumn(column IGridColumn) int {
	rv := objc.CallMethod[int](g_, "indexOfColumn:", column)
	return rv
}

func (g_ GridView) RowAtIndex(index int) GridRow {
	rv := objc.CallMethod[GridRow](g_, "rowAtIndex:", index)
	return rv
}

func (g_ GridView) ColumnAtIndex(index int) GridColumn {
	rv := objc.CallMethod[GridColumn](g_, "columnAtIndex:", index)
	return rv
}

func (g_ GridView) IndexOfRow(row IGridRow) int {
	rv := objc.CallMethod[int](g_, "indexOfRow:", row)
	return rv
}

func (g_ GridView) AddRowWithViews(views []IView) GridRow {
	rv := objc.CallMethod[GridRow](g_, "addRowWithViews:", views)
	return rv
}

func (g_ GridView) InsertRowAtIndex_WithViews(index int, views []IView) GridRow {
	rv := objc.CallMethod[GridRow](g_, "insertRowAtIndex:withViews:", index, views)
	return rv
}

func (g_ GridView) RemoveRowAtIndex(index int) {
	objc.CallMethod[objc.Void](g_, "removeRowAtIndex:", index)
}

func (g_ GridView) MoveRowAtIndex_ToIndex(fromIndex int, toIndex int) {
	objc.CallMethod[objc.Void](g_, "moveRowAtIndex:toIndex:", fromIndex, toIndex)
}

func (g_ GridView) AddColumnWithViews(views []IView) GridColumn {
	rv := objc.CallMethod[GridColumn](g_, "addColumnWithViews:", views)
	return rv
}

func (g_ GridView) InsertColumnAtIndex_WithViews(index int, views []IView) GridColumn {
	rv := objc.CallMethod[GridColumn](g_, "insertColumnAtIndex:withViews:", index, views)
	return rv
}

func (g_ GridView) RemoveColumnAtIndex(index int) {
	objc.CallMethod[objc.Void](g_, "removeColumnAtIndex:", index)
}

func (g_ GridView) MoveColumnAtIndex_ToIndex(fromIndex int, toIndex int) {
	objc.CallMethod[objc.Void](g_, "moveColumnAtIndex:toIndex:", fromIndex, toIndex)
}

func (g_ GridView) CellAtColumnIndex_RowIndex(columnIndex int, rowIndex int) GridCell {
	rv := objc.CallMethod[GridCell](g_, "cellAtColumnIndex:rowIndex:", columnIndex, rowIndex)
	return rv
}

func (g_ GridView) CellForView(view IView) GridCell {
	rv := objc.CallMethod[GridCell](g_, "cellForView:", view)
	return rv
}

func (g_ GridView) MergeCellsInHorizontalRange_VerticalRange(hRange foundation.Range, vRange foundation.Range) {
	objc.CallMethod[objc.Void](g_, "mergeCellsInHorizontalRange:verticalRange:", hRange, vRange)
}

func (g_ GridView) NumberOfRows() int {
	rv := objc.CallMethod[int](g_, "numberOfRows")
	return rv
}

func (g_ GridView) NumberOfColumns() int {
	rv := objc.CallMethod[int](g_, "numberOfColumns")
	return rv
}

func (g_ GridView) ColumnSpacing() float64 {
	rv := objc.CallMethod[float64](g_, "columnSpacing")
	return rv
}

func (g_ GridView) SetColumnSpacing(value float64) {
	objc.CallMethod[objc.Void](g_, "setColumnSpacing:", value)
}

func (g_ GridView) RowSpacing() float64 {
	rv := objc.CallMethod[float64](g_, "rowSpacing")
	return rv
}

func (g_ GridView) SetRowSpacing(value float64) {
	objc.CallMethod[objc.Void](g_, "setRowSpacing:", value)
}

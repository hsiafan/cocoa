...
func (v_ View) InitWithFrame(frameRect foundation.Rect) View {
	rv := objc.CallMethod[View](v_, "initWithFrame:", frameRect)
	return rv
}

func (v_ View) Init() View {
	rv := objc.CallMethod[View](v_, "init")
	return rv
}

func (vc _ViewClass) Alloc() View {
	rv := objc.CallMethod[View](vc, "alloc")
	return rv
}

func (vc _ViewClass) New() View {
	rv := objc.CallMethod[View](vc, "new")
	rv.Autorelease()
	return rv
}
...
func (v_ View) PrepareForReuse() {
	objc.CallMethod[objc.Void](v_, "prepareForReuse")
}

func (v_ View) IsDescendantOf(view IView) bool {
	rv := objc.CallMethod[bool](v_, "isDescendantOf:", view)
	return rv
}

func (v_ View) AncestorSharedWithView(view IView) View {
	rv := objc.CallMethod[View](v_, "ancestorSharedWithView:", view)
	return rv
}

func (v_ View) AddSubview(view IView) {
	objc.CallMethod[objc.Void](v_, "addSubview:", view)
}

func (v_ View) AddSubview_Positioned_RelativeTo(view IView, place WindowOrderingMode, otherView IView) {
	objc.CallMethod[objc.Void](v_, "addSubview:positioned:relativeTo:", view, place, otherView)
}

func (v_ View) RemoveFromSuperview() {
	objc.CallMethod[objc.Void](v_, "removeFromSuperview")
}

func (v_ View) RemoveFromSuperviewWithoutNeedingDisplay() {
	objc.CallMethod[objc.Void](v_, "removeFromSuperviewWithoutNeedingDisplay")
}

func (v_ View) ReplaceSubview_With(oldView IView, newView IView) {
	objc.CallMethod[objc.Void](v_, "replaceSubview:with:", oldView, newView)
}

func (v_ View) DidAddSubview(subview IView) {
	objc.CallMethod[objc.Void](v_, "didAddSubview:", subview)
}

func (v_ View) ViewDidMoveToSuperview() {
	objc.CallMethod[objc.Void](v_, "viewDidMoveToSuperview")
}

func (v_ View) ViewDidMoveToWindow() {
	objc.CallMethod[objc.Void](v_, "viewDidMoveToWindow")
}

func (v_ View) ViewWillMoveToSuperview(newSuperview IView) {
	objc.CallMethod[objc.Void](v_, "viewWillMoveToSuperview:", newSuperview)
}

func (v_ View) ViewWillMoveToWindow(newWindow IWindow) {
	objc.CallMethod[objc.Void](v_, "viewWillMoveToWindow:", newWindow)
}

func (v_ View) WillRemoveSubview(subview IView) {
	objc.CallMethod[objc.Void](v_, "willRemoveSubview:", subview)
}

func (v_ View) ViewWithTag(tag int) View {
	rv := objc.CallMethod[View](v_, "viewWithTag:", tag)
	return rv
}

func (v_ View) SetFrameOrigin(newOrigin foundation.Point) {
	objc.CallMethod[objc.Void](v_, "setFrameOrigin:", newOrigin)
}

func (v_ View) SetFrameSize(newSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "setFrameSize:", newSize)
}

func (v_ View) SetBoundsOrigin(newOrigin foundation.Point) {
	objc.CallMethod[objc.Void](v_, "setBoundsOrigin:", newOrigin)
}

func (v_ View) SetBoundsSize(newSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "setBoundsSize:", newSize)
}

func (v_ View) TranslateOriginToPoint(translation foundation.Point) {
	objc.CallMethod[objc.Void](v_, "translateOriginToPoint:", translation)
}

func (v_ View) ScaleUnitSquareToSize(newUnitSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "scaleUnitSquareToSize:", newUnitSize)
}

func (v_ View) RotateByAngle(angle float64) {
	objc.CallMethod[objc.Void](v_, "rotateByAngle:", angle)
}

func (v_ View) BackingAlignedRect_Options(rect foundation.Rect, options foundation.AlignmentOptions) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "backingAlignedRect:options:", rect, options)
	return rv
}

func (v_ View) ConvertPointFromBacking(point foundation.Point) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPointFromBacking:", point)
	return rv
}

func (v_ View) ConvertPointToBacking(point foundation.Point) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPointToBacking:", point)
	return rv
}

func (v_ View) ConvertPointFromLayer(point foundation.Point) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPointFromLayer:", point)
	return rv
}

func (v_ View) ConvertPointToLayer(point foundation.Point) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPointToLayer:", point)
	return rv
}

func (v_ View) ConvertRectFromBacking(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRectFromBacking:", rect)
	return rv
}

func (v_ View) ConvertRectToBacking(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRectToBacking:", rect)
	return rv
}

func (v_ View) ConvertRectFromLayer(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRectFromLayer:", rect)
	return rv
}

func (v_ View) ConvertRectToLayer(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRectToLayer:", rect)
	return rv
}

func (v_ View) ConvertSizeFromBacking(size foundation.Size) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSizeFromBacking:", size)
	return rv
}

func (v_ View) ConvertSizeToBacking(size foundation.Size) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSizeToBacking:", size)
	return rv
}

func (v_ View) ConvertSizeFromLayer(size foundation.Size) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSizeFromLayer:", size)
	return rv
}

func (v_ View) ConvertSizeToLayer(size foundation.Size) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSizeToLayer:", size)
	return rv
}

func (v_ View) ConvertPoint_FromView(point foundation.Point, view IView) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPoint:fromView:", point, view)
	return rv
}

func (v_ View) ConvertPoint_ToView(point foundation.Point, view IView) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPoint:toView:", point, view)
	return rv
}

func (v_ View) ConvertSize_FromView(size foundation.Size, view IView) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSize:fromView:", size, view)
	return rv
}

func (v_ View) ConvertSize_ToView(size foundation.Size, view IView) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSize:toView:", size, view)
	return rv
}

func (v_ View) ConvertRect_FromView(rect foundation.Rect, view IView) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRect:fromView:", rect, view)
	return rv
}

func (v_ View) ConvertRect_ToView(rect foundation.Rect, view IView) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRect:toView:", rect, view)
	return rv
}

func (v_ View) CenterScanRect(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "centerScanRect:", rect)
	return rv
}

func (v_ View) ViewDidHide() {
	objc.CallMethod[objc.Void](v_, "viewDidHide")
}

func (v_ View) ViewDidUnhide() {
	objc.CallMethod[objc.Void](v_, "viewDidUnhide")
}

func (v_ View) ViewDidChangeEffectiveAppearance() {
	objc.CallMethod[objc.Void](v_, "viewDidChangeEffectiveAppearance")
}

func (v_ View) ViewDidChangeBackingProperties() {
	objc.CallMethod[objc.Void](v_, "viewDidChangeBackingProperties")
}

func (v_ View) DrawFocusRingMask() {
	objc.CallMethod[objc.Void](v_, "drawFocusRingMask")
}

func (v_ View) NoteFocusRingMaskChanged() {
	objc.CallMethod[objc.Void](v_, "noteFocusRingMaskChanged")
}

func (v_ View) SetKeyboardFocusRingNeedsDisplayInRect(rect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "setKeyboardFocusRingNeedsDisplayInRect:", rect)
}

func (v_ View) MakeBackingLayer() quartzcore.Layer {
	rv := objc.CallMethod[quartzcore.Layer](v_, "makeBackingLayer")
	return rv
}

func (v_ View) MenuForEvent(event IEvent) Menu {
	rv := objc.CallMethod[Menu](v_, "menuForEvent:", event)
	return rv
}

func (v_ View) WillOpenMenu_WithEvent(menu IMenu, event IEvent) {
	objc.CallMethod[objc.Void](v_, "willOpenMenu:withEvent:", menu, event)
}

func (v_ View) DidCloseMenu_WithEvent(menu IMenu, event IEvent) {
	objc.CallMethod[objc.Void](v_, "didCloseMenu:withEvent:", menu, event)
}

func (v_ View) AddCursorRect_Cursor(rect foundation.Rect, object ICursor) {
	objc.CallMethod[objc.Void](v_, "addCursorRect:cursor:", rect, object)
}

func (v_ View) RemoveCursorRect_Cursor(rect foundation.Rect, object ICursor) {
	objc.CallMethod[objc.Void](v_, "removeCursorRect:cursor:", rect, object)
}

func (v_ View) DiscardCursorRects() {
	objc.CallMethod[objc.Void](v_, "discardCursorRects")
}

func (v_ View) ResetCursorRects() {
	objc.CallMethod[objc.Void](v_, "resetCursorRects")
}

func (v_ View) AddToolTipRect_Owner_UserData(rect foundation.Rect, owner objc.IObject, data unsafe.Pointer) ToolTipTag {
	rv := objc.CallMethod[ToolTipTag](v_, "addToolTipRect:owner:userData:", rect, owner, data)
	return rv
}

func (v_ View) RemoveAllToolTips() {
	objc.CallMethod[objc.Void](v_, "removeAllToolTips")
}

func (v_ View) RemoveToolTip(tag ToolTipTag) {
	objc.CallMethod[objc.Void](v_, "removeToolTip:", tag)
}
...
func (v_ View) ShowDefinitionForAttributedString_AtPoint(attrString foundation.IAttributedString, textBaselineOrigin foundation.Point) {
	objc.CallMethod[objc.Void](v_, "showDefinitionForAttributedString:atPoint:", attrString, textBaselineOrigin)
}
...
func (v_ View) SetContentCompressionResistancePriority_ForOrientation(priority LayoutPriority, orientation LayoutConstraintOrientation) {
	objc.CallMethod[objc.Void](v_, "setContentCompressionResistancePriority:forOrientation:", priority, orientation)
}

func (v_ View) ContentHuggingPriorityForOrientation(orientation LayoutConstraintOrientation) LayoutPriority {
	rv := objc.CallMethod[LayoutPriority](v_, "contentHuggingPriorityForOrientation:", orientation)
	return rv
}

func (v_ View) SetContentHuggingPriority_ForOrientation(priority LayoutPriority, orientation LayoutConstraintOrientation) {
	objc.CallMethod[objc.Void](v_, "setContentHuggingPriority:forOrientation:", priority, orientation)
}

func (v_ View) AddLayoutGuide(guide ILayoutGuide) {
	objc.CallMethod[objc.Void](v_, "addLayoutGuide:", guide)
}

func (v_ View) RemoveLayoutGuide(guide ILayoutGuide) {
	objc.CallMethod[objc.Void](v_, "removeLayoutGuide:", guide)
}

func (v_ View) AlignmentRectForFrame(frame foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "alignmentRectForFrame:", frame)
	return rv
}

func (v_ View) FrameForAlignmentRect(alignmentRect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "frameForAlignmentRect:", alignmentRect)
	return rv
}

func (v_ View) Layout() {
	objc.CallMethod[objc.Void](v_, "layout")
}

func (v_ View) LayoutSubtreeIfNeeded() {
	objc.CallMethod[objc.Void](v_, "layoutSubtreeIfNeeded")
}

func (v_ View) UpdateConstraints() {
	objc.CallMethod[objc.Void](v_, "updateConstraints")
}

func (v_ View) UpdateConstraintsForSubtreeIfNeeded() {
	objc.CallMethod[objc.Void](v_, "updateConstraintsForSubtreeIfNeeded")
}

func (v_ View) ConstraintsAffectingLayoutForOrientation(orientation LayoutConstraintOrientation) []LayoutConstraint {
	rv := objc.CallMethod[[]LayoutConstraint](v_, "constraintsAffectingLayoutForOrientation:", orientation)
	return rv
}

func (v_ View) ExerciseAmbiguityInLayout() {
	objc.CallMethod[objc.Void](v_, "exerciseAmbiguityInLayout")
}

func (v_ View) ResizeSubviewsWithOldSize(oldSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "resizeSubviewsWithOldSize:", oldSize)
}

func (v_ View) ResizeWithOldSuperviewSize(oldSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "resizeWithOldSuperviewSize:", oldSize)
}

func (v_ View) UpdateLayer() {
	objc.CallMethod[objc.Void](v_, "updateLayer")
}

func (v_ View) DrawRect(dirtyRect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "drawRect:", dirtyRect)
}

func (v_ View) NeedsToDrawRect(rect foundation.Rect) bool {
	rv := objc.CallMethod[bool](v_, "needsToDrawRect:", rect)
	return rv
}

func (v_ View) BitmapImageRepForCachingDisplayInRect(rect foundation.Rect) BitmapImageRep {
	rv := objc.CallMethod[BitmapImageRep](v_, "bitmapImageRepForCachingDisplayInRect:", rect)
	return rv
}

func (v_ View) CacheDisplayInRect_ToBitmapImageRep(rect foundation.Rect, bitmapImageRep IBitmapImageRep) {
	objc.CallMethod[objc.Void](v_, "cacheDisplayInRect:toBitmapImageRep:", rect, bitmapImageRep)
}

func (v_ View) EnterFullScreenMode_WithOptions(screen IScreen, options map[ViewFullScreenModeOptionKey]objc.IObject) bool {
	rv := objc.CallMethod[bool](v_, "enterFullScreenMode:withOptions:", screen, options)
	return rv
}

func (v_ View) ExitFullScreenModeWithOptions(options map[ViewFullScreenModeOptionKey]objc.IObject) {
	objc.CallMethod[objc.Void](v_, "exitFullScreenModeWithOptions:", options)
}

func (v_ View) SetNeedsDisplayInRect(invalidRect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "setNeedsDisplayInRect:", invalidRect)
}

func (v_ View) Display() {
	objc.CallMethod[objc.Void](v_, "display")
}

func (v_ View) DisplayRect(rect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "displayRect:", rect)
}

func (v_ View) DisplayRectIgnoringOpacity(rect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "displayRectIgnoringOpacity:", rect)
}

func (v_ View) DisplayRectIgnoringOpacity_InContext(rect foundation.Rect, context IGraphicsContext) {
	objc.CallMethod[objc.Void](v_, "displayRectIgnoringOpacity:inContext:", rect, context)
}

func (v_ View) DisplayIfNeeded() {
	objc.CallMethod[objc.Void](v_, "displayIfNeeded")
}

func (v_ View) DisplayIfNeededInRect(rect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "displayIfNeededInRect:", rect)
}

func (v_ View) DisplayIfNeededIgnoringOpacity() {
	objc.CallMethod[objc.Void](v_, "displayIfNeededIgnoringOpacity")
}

func (v_ View) DisplayIfNeededInRectIgnoringOpacity(rect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "displayIfNeededInRectIgnoringOpacity:", rect)
}

func (v_ View) TranslateRectsNeedingDisplayInRect_By(clipRect foundation.Rect, delta foundation.Size) {
	objc.CallMethod[objc.Void](v_, "translateRectsNeedingDisplayInRect:by:", clipRect, delta)
}

func (v_ View) ViewWillDraw() {
	objc.CallMethod[objc.Void](v_, "viewWillDraw")
}

func (v_ View) GetRectsExposedDuringLiveResize_Count(exposedRects *foundation.Rect, count *int) {
	objc.CallMethod[objc.Void](v_, "getRectsExposedDuringLiveResize:count:", exposedRects, count)
}

func (v_ View) ViewWillStartLiveResize() {
	objc.CallMethod[objc.Void](v_, "viewWillStartLiveResize")
}

func (v_ View) ViewDidEndLiveResize() {
	objc.CallMethod[objc.Void](v_, "viewDidEndLiveResize")
}

func (v_ View) Print(sender objc.IObject) {
	objc.CallMethod[objc.Void](v_, "print:", sender)
}

func (v_ View) BeginPageInRect_AtPlacement(rect foundation.Rect, location foundation.Point) {
	objc.CallMethod[objc.Void](v_, "beginPageInRect:atPlacement:", rect, location)
}

func (v_ View) DataWithEPSInsideRect(rect foundation.Rect) []byte {
	rv := objc.CallMethod[[]byte](v_, "dataWithEPSInsideRect:", rect)
	return rv
}

func (v_ View) DataWithPDFInsideRect(rect foundation.Rect) []byte {
	rv := objc.CallMethod[[]byte](v_, "dataWithPDFInsideRect:", rect)
	return rv
}

func (v_ View) WriteEPSInsideRect_ToPasteboard(rect foundation.Rect, pasteboard IPasteboard) {
	objc.CallMethod[objc.Void](v_, "writeEPSInsideRect:toPasteboard:", rect, pasteboard)
}

func (v_ View) WritePDFInsideRect_ToPasteboard(rect foundation.Rect, pasteboard IPasteboard) {
	objc.CallMethod[objc.Void](v_, "writePDFInsideRect:toPasteboard:", rect, pasteboard)
}

func (v_ View) DrawPageBorderWithSize(borderSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "drawPageBorderWithSize:", borderSize)
}

// deprecated
func (v_ View) DrawSheetBorderWithSize(borderSize foundation.Size) {
	objc.CallMethod[objc.Void](v_, "drawSheetBorderWithSize:", borderSize)
}

func (v_ View) AdjustPageWidthNew_Left_Right_Limit(newRight *float64, oldLeft float64, oldRight float64, rightLimit float64) {
	objc.CallMethod[objc.Void](v_, "adjustPageWidthNew:left:right:limit:", newRight, oldLeft, oldRight, rightLimit)
}

func (v_ View) AdjustPageHeightNew_Top_Bottom_Limit(newBottom *float64, oldTop float64, oldBottom float64, bottomLimit float64) {
	objc.CallMethod[objc.Void](v_, "adjustPageHeightNew:top:bottom:limit:", newBottom, oldTop, oldBottom, bottomLimit)
}

func (v_ View) KnowsPageRange(range_ *foundation.Range) bool {
	rv := objc.CallMethod[bool](v_, "knowsPageRange:", range_)
	return rv
}

func (v_ View) RectForPage(page int) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "rectForPage:", page)
	return rv
}

func (v_ View) LocationOfPrintRect(rect foundation.Rect) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "locationOfPrintRect:", rect)
	return rv
}

func (v_ View) BeginDocument() {
	objc.CallMethod[objc.Void](v_, "beginDocument")
}

func (v_ View) EndDocument() {
	objc.CallMethod[objc.Void](v_, "endDocument")
}

func (v_ View) EndPage() {
	objc.CallMethod[objc.Void](v_, "endPage")
}

func (v_ View) AcceptsFirstMouse(event IEvent) bool {
	rv := objc.CallMethod[bool](v_, "acceptsFirstMouse:", event)
	return rv
}

func (v_ View) HitTest(point foundation.Point) View {
	rv := objc.CallMethod[View](v_, "hitTest:", point)
	return rv
}

func (v_ View) Mouse_InRect(point foundation.Point, rect foundation.Rect) bool {
	rv := objc.CallMethod[bool](v_, "mouse:inRect:", point, rect)
	return rv
}

func (v_ View) AddGestureRecognizer(gestureRecognizer IGestureRecognizer) {
	objc.CallMethod[objc.Void](v_, "addGestureRecognizer:", gestureRecognizer)
}

func (v_ View) RemoveGestureRecognizer(gestureRecognizer IGestureRecognizer) {
	objc.CallMethod[objc.Void](v_, "removeGestureRecognizer:", gestureRecognizer)
}
...
func (v_ View) RectForSmartMagnificationAtPoint_InRect(location foundation.Point, visibleRect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "rectForSmartMagnificationAtPoint:inRect:", location, visibleRect)
	return rv
}

func (v_ View) AddTrackingArea(trackingArea ITrackingArea) {
	objc.CallMethod[objc.Void](v_, "addTrackingArea:", trackingArea)
}

func (v_ View) RemoveTrackingArea(trackingArea ITrackingArea) {
	objc.CallMethod[objc.Void](v_, "removeTrackingArea:", trackingArea)
}

func (v_ View) UpdateTrackingAreas() {
	objc.CallMethod[objc.Void](v_, "updateTrackingAreas")
}
...
func (v_ View) AddTrackingRect_Owner_UserData_AssumeInside(rect foundation.Rect, owner objc.IObject, data unsafe.Pointer, flag bool) TrackingRectTag {
	rv := objc.CallMethod[TrackingRectTag](v_, "addTrackingRect:owner:userData:assumeInside:", rect, owner, data, flag)
	return rv
}

func (v_ View) RemoveTrackingRect(tag TrackingRectTag) {
	objc.CallMethod[objc.Void](v_, "removeTrackingRect:", tag)
}

func (v_ View) PrepareContentInRect(rect foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "prepareContentInRect:", rect)
}

func (v_ View) ScrollPoint(point foundation.Point) {
	objc.CallMethod[objc.Void](v_, "scrollPoint:", point)
}

func (v_ View) ScrollRectToVisible(rect foundation.Rect) bool {
	rv := objc.CallMethod[bool](v_, "scrollRectToVisible:", rect)
	return rv
}

func (v_ View) Autoscroll(event IEvent) bool {
	rv := objc.CallMethod[bool](v_, "autoscroll:", event)
	return rv
}

func (v_ View) AdjustScroll(newVisible foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "adjustScroll:", newVisible)
	return rv
}

func (v_ View) ScrollClipView_ToPoint(clipView IClipView, point foundation.Point) {
	objc.CallMethod[objc.Void](v_, "scrollClipView:toPoint:", clipView, point)
}

func (v_ View) ReflectScrolledClipView(clipView IClipView) {
	objc.CallMethod[objc.Void](v_, "reflectScrolledClipView:", clipView)
}

func (v_ View) RegisterForDraggedTypes(newTypes []PasteboardType) {
	objc.CallMethod[objc.Void](v_, "registerForDraggedTypes:", newTypes)
}

func (v_ View) UnregisterDraggedTypes() {
	objc.CallMethod[objc.Void](v_, "unregisterDraggedTypes")
}
...
func (v_ View) BeginDraggingSessionWithItems_Event_Source(items []IDraggingItem, event IEvent, source DraggingSource) DraggingSession {
	...
	defer po.Release()
	rv := objc.CallMethod[DraggingSession](v_, "beginDraggingSessionWithItems:event:source:", items, event, po)
	return rv
}
...
func (v_ View) BeginDraggingSessionWithItems0_Event_Source(items []IDraggingItem, event IEvent, source objc.IObject) DraggingSession {
	rv := objc.CallMethod[DraggingSession](v_, "beginDraggingSessionWithItems:event:source:", items, event, source)
	return rv
}

func (v_ View) ShouldDelayWindowOrderingForEvent(event IEvent) bool {
	rv := objc.CallMethod[bool](v_, "shouldDelayWindowOrderingForEvent:", event)
	return rv
}

// deprecated
func (v_ View) LockFocus() {
	objc.CallMethod[objc.Void](v_, "lockFocus")
}

// deprecated
func (v_ View) LockFocusIfCanDraw() bool {
	rv := objc.CallMethod[bool](v_, "lockFocusIfCanDraw")
	return rv
}

// deprecated
func (v_ View) LockFocusIfCanDrawInContext(context IGraphicsContext) bool {
	rv := objc.CallMethod[bool](v_, "lockFocusIfCanDrawInContext:", context)
	return rv
}

// deprecated
func (v_ View) UnlockFocus() {
	objc.CallMethod[objc.Void](v_, "unlockFocus")
}

// deprecated
func (v_ View) ScrollRect_By(rect foundation.Rect, delta foundation.Size) {
	objc.CallMethod[objc.Void](v_, "scrollRect:by:", rect, delta)
}

// deprecated
func (v_ View) ConvertPointToBase(point foundation.Point) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPointToBase:", point)
	return rv
}

// deprecated
func (v_ View) ConvertPointFromBase(point foundation.Point) foundation.Point {
	rv := objc.CallMethod[foundation.Point](v_, "convertPointFromBase:", point)
	return rv
}

// deprecated
func (v_ View) ConvertSizeToBase(size foundation.Size) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSizeToBase:", size)
	return rv
}

// deprecated
func (v_ View) ConvertSizeFromBase(size foundation.Size) foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "convertSizeFromBase:", size)
	return rv
}

// deprecated
func (v_ View) ConvertRectToBase(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRectToBase:", rect)
	return rv
}

// deprecated
func (v_ View) ConvertRectFromBase(rect foundation.Rect) foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "convertRectFromBase:", rect)
	return rv
}

// deprecated
func (v_ View) ShouldDrawColor() bool {
	rv := objc.CallMethod[bool](v_, "shouldDrawColor")
	return rv
}

// deprecated
func (v_ View) AllocateGState() {
	objc.CallMethod[objc.Void](v_, "allocateGState")
}

// deprecated
func (v_ View) GState() int {
	rv := objc.CallMethod[int](v_, "gState")
	return rv
}

// deprecated
func (v_ View) SetUpGState() {
	objc.CallMethod[objc.Void](v_, "setUpGState")
}

// deprecated
func (v_ View) RenewGState() {
	objc.CallMethod[objc.Void](v_, "renewGState")
}
...
func (v_ View) DragImage_At_Offset_Event_Pasteboard_Source_SlideBack(image IImage, viewLocation foundation.Point, initialOffset foundation.Size, event IEvent, pboard IPasteboard, sourceObj objc.IObject, slideFlag bool) {
	objc.CallMethod[objc.Void](v_, "dragImage:at:offset:event:pasteboard:source:slideBack:", image, viewLocation, initialOffset, event, pboard, sourceObj, slideFlag)
}

// deprecated
func (v_ View) DragFile_FromRect_SlideBack_Event(filename string, rect foundation.Rect, flag bool, event IEvent) bool {
	rv := objc.CallMethod[bool](v_, "dragFile:fromRect:slideBack:event:", filename, rect, flag, event)
	return rv
}
...
func (v_ View) DragPromisedFilesOfTypes_FromRect_Source_SlideBack_Event(typeArray []string, rect foundation.Rect, sourceObject objc.IObject, flag bool, event IEvent) bool {
	rv := objc.CallMethod[bool](v_, "dragPromisedFilesOfTypes:fromRect:source:slideBack:event:", typeArray, rect, sourceObject, flag, event)
	return rv
}

func (v_ View) Superview() View {
	rv := objc.CallMethod[View](v_, "superview")
	return rv
}

func (v_ View) Subviews() []View {
	rv := objc.CallMethod[[]View](v_, "subviews")
	return rv
}

func (v_ View) SetSubviews(value []IView) {
	objc.CallMethod[objc.Void](v_, "setSubviews:", value)
}

func (v_ View) Window() Window {
	rv := objc.CallMethod[Window](v_, "window")
	return rv
}

func (v_ View) OpaqueAncestor() View {
	rv := objc.CallMethod[View](v_, "opaqueAncestor")
	return rv
}

func (v_ View) EnclosingMenuItem() MenuItem {
	rv := objc.CallMethod[MenuItem](v_, "enclosingMenuItem")
	return rv
}

func (v_ View) EnclosingScrollView() ScrollView {
	rv := objc.CallMethod[ScrollView](v_, "enclosingScrollView")
	return rv
}
...
func (v_ View) Frame() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "frame")
	return rv
}

func (v_ View) SetFrame(value foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "setFrame:", value)
}

func (v_ View) FrameRotation() float64 {
	rv := objc.CallMethod[float64](v_, "frameRotation")
	return rv
}

func (v_ View) SetFrameRotation(value float64) {
	objc.CallMethod[objc.Void](v_, "setFrameRotation:", value)
}

func (v_ View) PostsFrameChangedNotifications() bool {
	rv := objc.CallMethod[bool](v_, "postsFrameChangedNotifications")
	return rv
}

func (v_ View) SetPostsFrameChangedNotifications(value bool) {
	objc.CallMethod[objc.Void](v_, "setPostsFrameChangedNotifications:", value)
}

func (v_ View) Bounds() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "bounds")
	return rv
}

func (v_ View) SetBounds(value foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "setBounds:", value)
}

func (v_ View) BoundsRotation() float64 {
	rv := objc.CallMethod[float64](v_, "boundsRotation")
	return rv
}

func (v_ View) SetBoundsRotation(value float64) {
	objc.CallMethod[objc.Void](v_, "setBoundsRotation:", value)
}

func (v_ View) PostsBoundsChangedNotifications() bool {
	rv := objc.CallMethod[bool](v_, "postsBoundsChangedNotifications")
	return rv
}

func (v_ View) SetPostsBoundsChangedNotifications(value bool) {
	objc.CallMethod[objc.Void](v_, "setPostsBoundsChangedNotifications:", value)
}

func (v_ View) IsFlipped() bool {
	rv := objc.CallMethod[bool](v_, "isFlipped")
	return rv
}

func (v_ View) IsRotatedFromBase() bool {
	rv := objc.CallMethod[bool](v_, "isRotatedFromBase")
	return rv
}

func (v_ View) IsRotatedOrScaledFromBase() bool {
	rv := objc.CallMethod[bool](v_, "isRotatedOrScaledFromBase")
	return rv
}

func (v_ View) IsHidden() bool {
	rv := objc.CallMethod[bool](v_, "isHidden")
	return rv
}

func (v_ View) SetHidden(value bool) {
	objc.CallMethod[objc.Void](v_, "setHidden:", value)
}

func (v_ View) IsHiddenOrHasHiddenAncestor() bool {
	rv := objc.CallMethod[bool](v_, "isHiddenOrHasHiddenAncestor")
	return rv
}

func (v_ View) AllowsVibrancy() bool {
	rv := objc.CallMethod[bool](v_, "allowsVibrancy")
	return rv
}

func (v_ View) FocusRingType() FocusRingType {
	rv := objc.CallMethod[FocusRingType](v_, "focusRingType")
	return rv
}

func (v_ View) SetFocusRingType(value FocusRingType) {
	objc.CallMethod[objc.Void](v_, "setFocusRingType:", value)
}

func (v_ View) FocusRingMaskBounds() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "focusRingMaskBounds")
	return rv
}

func (vc _ViewClass) DefaultFocusRingType() FocusRingType {
	rv := objc.CallMethod[FocusRingType](vc, "defaultFocusRingType")
	return rv
}

func (v_ View) IsDrawingFindIndicator() bool {
	rv := objc.CallMethod[bool](v_, "isDrawingFindIndicator")
	return rv
}

func (v_ View) WantsLayer() bool {
	rv := objc.CallMethod[bool](v_, "wantsLayer")
	return rv
}

func (v_ View) SetWantsLayer(value bool) {
	objc.CallMethod[objc.Void](v_, "setWantsLayer:", value)
}

func (v_ View) WantsUpdateLayer() bool {
	rv := objc.CallMethod[bool](v_, "wantsUpdateLayer")
	return rv
}

func (v_ View) Layer() quartzcore.Layer {
	rv := objc.CallMethod[quartzcore.Layer](v_, "layer")
	return rv
}

func (v_ View) SetLayer(value quartzcore.ILayer) {
	objc.CallMethod[objc.Void](v_, "setLayer:", value)
}

func (v_ View) LayerContentsPlacement() ViewLayerContentsPlacement {
	rv := objc.CallMethod[ViewLayerContentsPlacement](v_, "layerContentsPlacement")
	return rv
}

func (v_ View) SetLayerContentsPlacement(value ViewLayerContentsPlacement) {
	objc.CallMethod[objc.Void](v_, "setLayerContentsPlacement:", value)
}

func (v_ View) LayerContentsRedrawPolicy() ViewLayerContentsRedrawPolicy {
	rv := objc.CallMethod[ViewLayerContentsRedrawPolicy](v_, "layerContentsRedrawPolicy")
	return rv
}

func (v_ View) SetLayerContentsRedrawPolicy(value ViewLayerContentsRedrawPolicy) {
	objc.CallMethod[objc.Void](v_, "setLayerContentsRedrawPolicy:", value)
}

func (v_ View) CanDrawSubviewsIntoLayer() bool {
	rv := objc.CallMethod[bool](v_, "canDrawSubviewsIntoLayer")
	return rv
}

func (v_ View) SetCanDrawSubviewsIntoLayer(value bool) {
	objc.CallMethod[objc.Void](v_, "setCanDrawSubviewsIntoLayer:", value)
}

func (v_ View) LayerUsesCoreImageFilters() bool {
	rv := objc.CallMethod[bool](v_, "layerUsesCoreImageFilters")
	return rv
}

func (v_ View) SetLayerUsesCoreImageFilters(value bool) {
	objc.CallMethod[objc.Void](v_, "setLayerUsesCoreImageFilters:", value)
}

func (v_ View) AlphaValue() float64 {
	rv := objc.CallMethod[float64](v_, "alphaValue")
	return rv
}

func (v_ View) SetAlphaValue(value float64) {
	objc.CallMethod[objc.Void](v_, "setAlphaValue:", value)
}

func (v_ View) FrameCenterRotation() float64 {
	rv := objc.CallMethod[float64](v_, "frameCenterRotation")
	return rv
}

func (v_ View) SetFrameCenterRotation(value float64) {
	objc.CallMethod[objc.Void](v_, "setFrameCenterRotation:", value)
}

func (v_ View) Shadow() Shadow {
	rv := objc.CallMethod[Shadow](v_, "shadow")
	return rv
}

func (v_ View) SetShadow(value IShadow) {
	objc.CallMethod[objc.Void](v_, "setShadow:", value)
}

func (vc _ViewClass) DefaultMenu() Menu {
	rv := objc.CallMethod[Menu](vc, "defaultMenu")
	return rv
}

func (v_ View) ToolTip() string {
	rv := objc.CallMethod[string](v_, "toolTip")
	return rv
}

func (v_ View) SetToolTip(value string) {
	objc.CallMethod[objc.Void](v_, "setToolTip:", value)
}

func (vc _ViewClass) FocusView() View {
	rv := objc.CallMethod[View](vc, "focusView")
	return rv
}

func (v_ View) SafeAreaRect() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "safeAreaRect")
	return rv
}

func (v_ View) SafeAreaInsets() foundation.EdgeInsets {
	rv := objc.CallMethod[foundation.EdgeInsets](v_, "safeAreaInsets")
	return rv
}

func (v_ View) AdditionalSafeAreaInsets() foundation.EdgeInsets {
	rv := objc.CallMethod[foundation.EdgeInsets](v_, "additionalSafeAreaInsets")
	return rv
}

func (v_ View) SetAdditionalSafeAreaInsets(value foundation.EdgeInsets) {
	objc.CallMethod[objc.Void](v_, "setAdditionalSafeAreaInsets:", value)
}

func (v_ View) SafeAreaLayoutGuide() LayoutGuide {
	rv := objc.CallMethod[LayoutGuide](v_, "safeAreaLayoutGuide")
	return rv
}

func (v_ View) UserInterfaceLayoutDirection() UserInterfaceLayoutDirection {
	rv := objc.CallMethod[UserInterfaceLayoutDirection](v_, "userInterfaceLayoutDirection")
	return rv
}

func (v_ View) SetUserInterfaceLayoutDirection(value UserInterfaceLayoutDirection) {
	objc.CallMethod[objc.Void](v_, "setUserInterfaceLayoutDirection:", value)
}

func (vc _ViewClass) RequiresConstraintBasedLayout() bool {
	rv := objc.CallMethod[bool](vc, "requiresConstraintBasedLayout")
	return rv
}

func (v_ View) TranslatesAutoresizingMaskIntoConstraints() bool {
	rv := objc.CallMethod[bool](v_, "translatesAutoresizingMaskIntoConstraints")
	return rv
}

func (v_ View) SetTranslatesAutoresizingMaskIntoConstraints(value bool) {
	objc.CallMethod[objc.Void](v_, "setTranslatesAutoresizingMaskIntoConstraints:", value)
}

func (v_ View) BottomAnchor() LayoutYAxisAnchor {
	rv := objc.CallMethod[LayoutYAxisAnchor](v_, "bottomAnchor")
	return rv
}

func (v_ View) CenterXAnchor() LayoutXAxisAnchor {
	rv := objc.CallMethod[LayoutXAxisAnchor](v_, "centerXAnchor")
	return rv
}

func (v_ View) CenterYAnchor() LayoutYAxisAnchor {
	rv := objc.CallMethod[LayoutYAxisAnchor](v_, "centerYAnchor")
	return rv
}

func (v_ View) FirstBaselineAnchor() LayoutYAxisAnchor {
	rv := objc.CallMethod[LayoutYAxisAnchor](v_, "firstBaselineAnchor")
	return rv
}

func (v_ View) HeightAnchor() LayoutDimension {
	rv := objc.CallMethod[LayoutDimension](v_, "heightAnchor")
	return rv
}

func (v_ View) LastBaselineAnchor() LayoutYAxisAnchor {
	rv := objc.CallMethod[LayoutYAxisAnchor](v_, "lastBaselineAnchor")
	return rv
}

func (v_ View) LeadingAnchor() LayoutXAxisAnchor {
	rv := objc.CallMethod[LayoutXAxisAnchor](v_, "leadingAnchor")
	return rv
}

func (v_ View) LeftAnchor() LayoutXAxisAnchor {
	rv := objc.CallMethod[LayoutXAxisAnchor](v_, "leftAnchor")
	return rv
}

func (v_ View) RightAnchor() LayoutXAxisAnchor {
	rv := objc.CallMethod[LayoutXAxisAnchor](v_, "rightAnchor")
	return rv
}

func (v_ View) TopAnchor() LayoutYAxisAnchor {
	rv := objc.CallMethod[LayoutYAxisAnchor](v_, "topAnchor")
	return rv
}

func (v_ View) TrailingAnchor() LayoutXAxisAnchor {
	rv := objc.CallMethod[LayoutXAxisAnchor](v_, "trailingAnchor")
	return rv
}

func (v_ View) WidthAnchor() LayoutDimension {
	rv := objc.CallMethod[LayoutDimension](v_, "widthAnchor")
	return rv
}

func (v_ View) Constraints() []LayoutConstraint {
	rv := objc.CallMethod[[]LayoutConstraint](v_, "constraints")
	return rv
}

func (v_ View) FittingSize() foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "fittingSize")
	return rv
}

func (v_ View) IntrinsicContentSize() foundation.Size {
	rv := objc.CallMethod[foundation.Size](v_, "intrinsicContentSize")
	return rv
}

func (v_ View) LayoutGuides() []LayoutGuide {
	rv := objc.CallMethod[[]LayoutGuide](v_, "layoutGuides")
	return rv
}

func (v_ View) LayoutMarginsGuide() LayoutGuide {
	rv := objc.CallMethod[LayoutGuide](v_, "layoutMarginsGuide")
	return rv
}

func (v_ View) AlignmentRectInsets() foundation.EdgeInsets {
	rv := objc.CallMethod[foundation.EdgeInsets](v_, "alignmentRectInsets")
	return rv
}

func (v_ View) BaselineOffsetFromBottom() float64 {
	rv := objc.CallMethod[float64](v_, "baselineOffsetFromBottom")
	return rv
}

func (v_ View) FirstBaselineOffsetFromTop() float64 {
	rv := objc.CallMethod[float64](v_, "firstBaselineOffsetFromTop")
	return rv
}

func (v_ View) LastBaselineOffsetFromBottom() float64 {
	rv := objc.CallMethod[float64](v_, "lastBaselineOffsetFromBottom")
	return rv
}

func (v_ View) NeedsLayout() bool {
	rv := objc.CallMethod[bool](v_, "needsLayout")
	return rv
}

func (v_ View) SetNeedsLayout(value bool) {
	objc.CallMethod[objc.Void](v_, "setNeedsLayout:", value)
}

func (v_ View) NeedsUpdateConstraints() bool {
	rv := objc.CallMethod[bool](v_, "needsUpdateConstraints")
	return rv
}

func (v_ View) SetNeedsUpdateConstraints(value bool) {
	objc.CallMethod[objc.Void](v_, "setNeedsUpdateConstraints:", value)
}

func (v_ View) IsHorizontalContentSizeConstraintActive() bool {
	rv := objc.CallMethod[bool](v_, "isHorizontalContentSizeConstraintActive")
	return rv
}

func (v_ View) SetHorizontalContentSizeConstraintActive(value bool) {
	objc.CallMethod[objc.Void](v_, "setHorizontalContentSizeConstraintActive:", value)
}

func (v_ View) IsVerticalContentSizeConstraintActive() bool {
	rv := objc.CallMethod[bool](v_, "isVerticalContentSizeConstraintActive")
	return rv
}

func (v_ View) SetVerticalContentSizeConstraintActive(value bool) {
	objc.CallMethod[objc.Void](v_, "setVerticalContentSizeConstraintActive:", value)
}

func (v_ View) HasAmbiguousLayout() bool {
	rv := objc.CallMethod[bool](v_, "hasAmbiguousLayout")
	return rv
}

func (v_ View) AutoresizesSubviews() bool {
	rv := objc.CallMethod[bool](v_, "autoresizesSubviews")
	return rv
}

func (v_ View) SetAutoresizesSubviews(value bool) {
	objc.CallMethod[objc.Void](v_, "setAutoresizesSubviews:", value)
}

func (v_ View) AutoresizingMask() AutoresizingMaskOptions {
	rv := objc.CallMethod[AutoresizingMaskOptions](v_, "autoresizingMask")
	return rv
}

func (v_ View) SetAutoresizingMask(value AutoresizingMaskOptions) {
	objc.CallMethod[objc.Void](v_, "setAutoresizingMask:", value)
}

func (v_ View) CanDrawConcurrently() bool {
	rv := objc.CallMethod[bool](v_, "canDrawConcurrently")
	return rv
}

func (v_ View) SetCanDrawConcurrently(value bool) {
	objc.CallMethod[objc.Void](v_, "setCanDrawConcurrently:", value)
}

func (v_ View) VisibleRect() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "visibleRect")
	return rv
}

func (v_ View) WantsDefaultClipping() bool {
	rv := objc.CallMethod[bool](v_, "wantsDefaultClipping")
	return rv
}

func (v_ View) IsInFullScreenMode() bool {
	rv := objc.CallMethod[bool](v_, "isInFullScreenMode")
	return rv
}

func (v_ View) NeedsDisplay() bool {
	rv := objc.CallMethod[bool](v_, "needsDisplay")
	return rv
}

func (v_ View) SetNeedsDisplay(value bool) {
	objc.CallMethod[objc.Void](v_, "setNeedsDisplay:", value)
}

func (v_ View) IsOpaque() bool {
	rv := objc.CallMethod[bool](v_, "isOpaque")
	return rv
}

func (v_ View) InLiveResize() bool {
	rv := objc.CallMethod[bool](v_, "inLiveResize")
	return rv
}

func (v_ View) PreservesContentDuringLiveResize() bool {
	rv := objc.CallMethod[bool](v_, "preservesContentDuringLiveResize")
	return rv
}

func (v_ View) RectPreservedDuringLiveResize() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "rectPreservedDuringLiveResize")
	return rv
}

func (v_ View) PrintJobTitle() string {
	rv := objc.CallMethod[string](v_, "printJobTitle")
	return rv
}

func (v_ View) PageHeader() foundation.AttributedString {
	rv := objc.CallMethod[foundation.AttributedString](v_, "pageHeader")
	return rv
}

func (v_ View) PageFooter() foundation.AttributedString {
	rv := objc.CallMethod[foundation.AttributedString](v_, "pageFooter")
	return rv
}

func (v_ View) HeightAdjustLimit() float64 {
	rv := objc.CallMethod[float64](v_, "heightAdjustLimit")
	return rv
}

func (v_ View) WidthAdjustLimit() float64 {
	rv := objc.CallMethod[float64](v_, "widthAdjustLimit")
	return rv
}

func (v_ View) MouseDownCanMoveWindow() bool {
	rv := objc.CallMethod[bool](v_, "mouseDownCanMoveWindow")
	return rv
}

func (v_ View) InputContext() TextInputContext {
	rv := objc.CallMethod[TextInputContext](v_, "inputContext")
	return rv
}

func (v_ View) AllowedTouchTypes() TouchTypeMask {
	rv := objc.CallMethod[TouchTypeMask](v_, "allowedTouchTypes")
	return rv
}

func (v_ View) SetAllowedTouchTypes(value TouchTypeMask) {
	objc.CallMethod[objc.Void](v_, "setAllowedTouchTypes:", value)
}

func (v_ View) WantsRestingTouches() bool {
	rv := objc.CallMethod[bool](v_, "wantsRestingTouches")
	return rv
}

func (v_ View) SetWantsRestingTouches(value bool) {
	objc.CallMethod[objc.Void](v_, "setWantsRestingTouches:", value)
}

func (v_ View) CandidateListTouchBarItem() CandidateListTouchBarItem {
	rv := objc.CallMethod[CandidateListTouchBarItem](v_, "candidateListTouchBarItem")
	return rv
}

func (v_ View) GestureRecognizers() []GestureRecognizer {
	rv := objc.CallMethod[[]GestureRecognizer](v_, "gestureRecognizers")
	return rv
}

func (v_ View) SetGestureRecognizers(value []IGestureRecognizer) {
	objc.CallMethod[objc.Void](v_, "setGestureRecognizers:", value)
}

func (v_ View) CanBecomeKeyView() bool {
	rv := objc.CallMethod[bool](v_, "canBecomeKeyView")
	return rv
}

func (v_ View) NeedsPanelToBecomeKey() bool {
	rv := objc.CallMethod[bool](v_, "needsPanelToBecomeKey")
	return rv
}

func (v_ View) NextKeyView() View {
	rv := objc.CallMethod[View](v_, "nextKeyView")
	return rv
}

func (v_ View) SetNextKeyView(value IView) {
	objc.CallMethod[objc.Void](v_, "setNextKeyView:", value)
}

func (v_ View) NextValidKeyView() View {
	rv := objc.CallMethod[View](v_, "nextValidKeyView")
	return rv
}

func (v_ View) PreviousKeyView() View {
	rv := objc.CallMethod[View](v_, "previousKeyView")
	return rv
}

func (v_ View) PreviousValidKeyView() View {
	rv := objc.CallMethod[View](v_, "previousValidKeyView")
	return rv
}

func (v_ View) TrackingAreas() []TrackingArea {
	rv := objc.CallMethod[[]TrackingArea](v_, "trackingAreas")
	return rv
}

func (v_ View) PreparedContentRect() foundation.Rect {
	rv := objc.CallMethod[foundation.Rect](v_, "preparedContentRect")
	return rv
}

func (v_ View) SetPreparedContentRect(value foundation.Rect) {
	objc.CallMethod[objc.Void](v_, "setPreparedContentRect:", value)
}

func (vc _ViewClass) IsCompatibleWithResponsiveScrolling() bool {
	rv := objc.CallMethod[bool](vc, "isCompatibleWithResponsiveScrolling")
	return rv
}

func (v_ View) PressureConfiguration() PressureConfiguration {
	rv := objc.CallMethod[PressureConfiguration](v_, "pressureConfiguration")
	return rv
}

func (v_ View) SetPressureConfiguration(value IPressureConfiguration) {
	objc.CallMethod[objc.Void](v_, "setPressureConfiguration:", value)
}

func (v_ View) RegisteredDraggedTypes() []PasteboardType {
	rv := objc.CallMethod[[]PasteboardType](v_, "registeredDraggedTypes")
	return rv
}

// deprecated
func (v_ View) WantsExtendedDynamicRangeOpenGLSurface() bool {
	rv := objc.CallMethod[bool](v_, "wantsExtendedDynamicRangeOpenGLSurface")
	return rv
}

// deprecated
func (v_ View) SetWantsExtendedDynamicRangeOpenGLSurface(value bool) {
	objc.CallMethod[objc.Void](v_, "setWantsExtendedDynamicRangeOpenGLSurface:", value)
}

// deprecated
func (v_ View) AcceptsTouchEvents() bool {
	rv := objc.CallMethod[bool](v_, "acceptsTouchEvents")
	return rv
}

// deprecated
func (v_ View) SetAcceptsTouchEvents(value bool) {
	objc.CallMethod[objc.Void](v_, "setAcceptsTouchEvents:", value)
}

// deprecated
func (v_ View) CanDraw() bool {
	rv := objc.CallMethod[bool](v_, "canDraw")
	return rv
}

// deprecated
func (v_ View) WantsBestResolutionOpenGLSurface() bool {
	rv := objc.CallMethod[bool](v_, "wantsBestResolutionOpenGLSurface")
	return rv
}

// deprecated
func (v_ View) SetWantsBestResolutionOpenGLSurface(value bool) {
	objc.CallMethod[objc.Void](v_, "setWantsBestResolutionOpenGLSurface:", value)
}

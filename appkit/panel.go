...
func (pc _PanelClass) WindowWithContentViewController(contentViewController IViewController) Panel {
	rv := objc.CallMethod[Panel](pc, "windowWithContentViewController:", contentViewController)
	return rv
}
...
func (p_ Panel) InitWithContentRect_StyleMask_Backing_Defer(contentRect foundation.Rect, style WindowStyleMask, backingStoreType BackingStoreType, flag bool) Panel {
	rv := objc.CallMethod[Panel](p_, "initWithContentRect:styleMask:backing:defer:", contentRect, style, backingStoreType, flag)
	return rv
}
...
func (p_ Panel) InitWithContentRect_StyleMask_Backing_Defer_Screen(contentRect foundation.Rect, style WindowStyleMask, backingStoreType BackingStoreType, flag bool, screen IScreen) Panel {
	rv := objc.CallMethod[Panel](p_, "initWithContentRect:styleMask:backing:defer:screen:", contentRect, style, backingStoreType, flag, screen)
	return rv
}

func (p_ Panel) Init() Panel {
	rv := objc.CallMethod[Panel](p_, "init")
	return rv
}

func (pc _PanelClass) Alloc() Panel {
	rv := objc.CallMethod[Panel](pc, "alloc")
	return rv
}

func (pc _PanelClass) New() Panel {
	rv := objc.CallMethod[Panel](pc, "new")
	rv.Autorelease()
	return rv
}
...
func (p_ Panel) SetFloatingPanel(value bool) {
	objc.CallMethod[objc.Void](p_, "setFloatingPanel:", value)
}

func (p_ Panel) BecomesKeyOnlyIfNeeded() bool {
	rv := objc.CallMethod[bool](p_, "becomesKeyOnlyIfNeeded")
	return rv
}

func (p_ Panel) SetBecomesKeyOnlyIfNeeded(value bool) {
	objc.CallMethod[objc.Void](p_, "setBecomesKeyOnlyIfNeeded:", value)
}

func (p_ Panel) SetWorksWhenModal(value bool) {
	objc.CallMethod[objc.Void](p_, "setWorksWhenModal:", value)
}

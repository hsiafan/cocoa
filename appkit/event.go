...
func (ec _EventClass) Alloc() Event {
	rv := objc.CallMethod[Event](ec, "alloc")
	return rv
}

func (ec _EventClass) New() Event {
	rv := objc.CallMethod[Event](ec, "new")
	rv.Autorelease()
	return rv
}
...
func (e_ Event) Init() Event {
	rv := objc.CallMethod[Event](e_, "init")
	return rv
}
...
func (ec _EventClass) KeyEventWithType_Location_ModifierFlags_Timestamp_WindowNumber_Context_Characters_CharactersIgnoringModifiers_IsARepeat_KeyCode(type_ EventType, location foundation.Point, flags EventModifierFlags, time foundation.TimeInterval, wNum int, unusedPassNil IGraphicsContext, keys string, ukeys string, flag bool, code uint16) Event {
	rv := objc.CallMethod[Event](ec, "keyEventWithType:location:modifierFlags:timestamp:windowNumber:context:characters:charactersIgnoringModifiers:isARepeat:keyCode:", type_, location, flags, time, wNum, unusedPassNil, keys, ukeys, flag, code)
	return rv
}
...
func (ec _EventClass) MouseEventWithType_Location_ModifierFlags_Timestamp_WindowNumber_Context_EventNumber_ClickCount_Pressure(type_ EventType, location foundation.Point, flags EventModifierFlags, time foundation.TimeInterval, wNum int, unusedPassNil IGraphicsContext, eNum int, cNum int, pressure float32) Event {
	rv := objc.CallMethod[Event](ec, "mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:", type_, location, flags, time, wNum, unusedPassNil, eNum, cNum, pressure)
	return rv
}
...
func (ec _EventClass) EnterExitEventWithType_Location_ModifierFlags_Timestamp_WindowNumber_Context_EventNumber_TrackingNumber_UserData(type_ EventType, location foundation.Point, flags EventModifierFlags, time foundation.TimeInterval, wNum int, unusedPassNil IGraphicsContext, eNum int, tNum int, data unsafe.Pointer) Event {
	rv := objc.CallMethod[Event](ec, "enterExitEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:trackingNumber:userData:", type_, location, flags, time, wNum, unusedPassNil, eNum, tNum, data)
	return rv
}
...
func (ec _EventClass) OtherEventWithType_Location_ModifierFlags_Timestamp_WindowNumber_Context_Subtype_Data1_Data2(type_ EventType, location foundation.Point, flags EventModifierFlags, time foundation.TimeInterval, wNum int, unusedPassNil IGraphicsContext, subtype int16, d1 int, d2 int) Event {
	rv := objc.CallMethod[Event](ec, "otherEventWithType:location:modifierFlags:timestamp:windowNumber:context:subtype:data1:data2:", type_, location, flags, time, wNum, unusedPassNil, subtype, d1, d2)
	return rv
}

func (ec _EventClass) EventWithEventRef(eventRef unsafe.Pointer) Event {
	rv := objc.CallMethod[Event](ec, "eventWithEventRef:", eventRef)
	return rv
}

func (ec _EventClass) EventWithCGEvent(cgEvent coregraphics.EventRef) Event {
	rv := objc.CallMethod[Event](ec, "eventWithCGEvent:", cgEvent)
	return rv
}

func (e_ Event) CharactersByApplyingModifiers(modifiers EventModifierFlags) string {
	rv := objc.CallMethod[string](e_, "charactersByApplyingModifiers:", modifiers)
	return rv
}
...
func (e_ Event) TrackSwipeEventWithOptions_DampenAmountThresholdMin_Max_UsingHandler(options EventSwipeTrackingOptions, minDampenThreshold float64, maxDampenThreshold float64, trackingHandler func(gestureAmount float64, phase EventPhase, isComplete bool, stop *bool)) {
	objc.CallMethod[objc.Void](e_, "trackSwipeEventWithOptions:dampenAmountThresholdMin:max:usingHandler:", options, minDampenThreshold, maxDampenThreshold, trackingHandler)
}

func (e_ Event) TouchesMatchingPhase_InView(phase TouchPhase, view IView) foundation.Set {
	rv := objc.CallMethod[foundation.Set](e_, "touchesMatchingPhase:inView:", phase, view)
	return rv
}

func (e_ Event) AllTouches() foundation.Set {
	rv := objc.CallMethod[foundation.Set](e_, "allTouches")
	return rv
}

func (e_ Event) TouchesForView(view IView) foundation.Set {
	rv := objc.CallMethod[foundation.Set](e_, "touchesForView:", view)
	return rv
}

func (e_ Event) CoalescedTouchesForTouch(touch ITouch) []Touch {
	rv := objc.CallMethod[[]Touch](e_, "coalescedTouchesForTouch:", touch)
	return rv
}
...
func (ec _EventClass) StartPeriodicEventsAfterDelay_WithPeriod(delay foundation.TimeInterval, period foundation.TimeInterval) {
	objc.CallMethod[objc.Void](ec, "startPeriodicEventsAfterDelay:withPeriod:", delay, period)
}

func (ec _EventClass) StopPeriodicEvents() {
	objc.CallMethod[objc.Void](ec, "stopPeriodicEvents")
}

func (ec _EventClass) AddGlobalMonitorForEventsMatchingMask_Handler(mask EventMask, block func(event Event)) objc.Object {
	rv := objc.CallMethod[objc.Object](ec, "addGlobalMonitorForEventsMatchingMask:handler:", mask, block)
	return rv
}
...
func (ec _EventClass) AddLocalMonitorForEventsMatchingMask_Handler(mask EventMask, block func(event Event) IEvent) objc.Object {
	rv := objc.CallMethod[objc.Object](ec, "addLocalMonitorForEventsMatchingMask:handler:", mask, block)
	return rv
}

func (ec _EventClass) RemoveMonitor(eventMonitor objc.IObject) {
	objc.CallMethod[objc.Void](ec, "removeMonitor:", eventMonitor)
}

func (e_ Event) Type() EventType {
	rv := objc.CallMethod[EventType](e_, "type")
	return rv
}

func (e_ Event) Subtype() EventSubtype {
	rv := objc.CallMethod[EventSubtype](e_, "subtype")
	return rv
}

func (e_ Event) LocationInWindow() foundation.Point {
	rv := objc.CallMethod[foundation.Point](e_, "locationInWindow")
	return rv
}

func (e_ Event) Timestamp() foundation.TimeInterval {
	rv := objc.CallMethod[foundation.TimeInterval](e_, "timestamp")
	return rv
}

func (e_ Event) Window() Window {
	rv := objc.CallMethod[Window](e_, "window")
	return rv
}

func (e_ Event) WindowNumber() int {
	rv := objc.CallMethod[int](e_, "windowNumber")
	return rv
}

func (e_ Event) EventRef() unsafe.Pointer {
	rv := objc.CallMethod[unsafe.Pointer](e_, "eventRef")
	return rv
}

func (e_ Event) CGEvent() coregraphics.EventRef {
	rv := objc.CallMethod[coregraphics.EventRef](e_, "CGEvent")
	return rv
}

func (e_ Event) ModifierFlags() EventModifierFlags {
	rv := objc.CallMethod[EventModifierFlags](e_, "modifierFlags")
	return rv
}

func (e_ Event) Characters() string {
	rv := objc.CallMethod[string](e_, "characters")
	return rv
}

func (e_ Event) CharactersIgnoringModifiers() string {
	rv := objc.CallMethod[string](e_, "charactersIgnoringModifiers")
	return rv
}

func (e_ Event) KeyCode() uint16 {
	rv := objc.CallMethod[uint16](e_, "keyCode")
	return rv
}

func (ec _EventClass) KeyRepeatDelay() foundation.TimeInterval {
	rv := objc.CallMethod[foundation.TimeInterval](ec, "keyRepeatDelay")
	return rv
}

func (ec _EventClass) KeyRepeatInterval() foundation.TimeInterval {
	rv := objc.CallMethod[foundation.TimeInterval](ec, "keyRepeatInterval")
	return rv
}

func (e_ Event) IsARepeat() bool {
	rv := objc.CallMethod[bool](e_, "isARepeat")
	return rv
}

func (ec _EventClass) PressedMouseButtons() uint {
	rv := objc.CallMethod[uint](ec, "pressedMouseButtons")
	return rv
}

func (ec _EventClass) DoubleClickInterval() foundation.TimeInterval {
	rv := objc.CallMethod[foundation.TimeInterval](ec, "doubleClickInterval")
	return rv
}

func (ec _EventClass) MouseLocation() foundation.Point {
	rv := objc.CallMethod[foundation.Point](ec, "mouseLocation")
	return rv
}

func (e_ Event) ButtonNumber() int {
	rv := objc.CallMethod[int](e_, "buttonNumber")
	return rv
}

func (e_ Event) ClickCount() int {
	rv := objc.CallMethod[int](e_, "clickCount")
	return rv
}

func (e_ Event) AssociatedEventsMask() EventMask {
	rv := objc.CallMethod[EventMask](e_, "associatedEventsMask")
	return rv
}

func (e_ Event) DeltaX() float64 {
	rv := objc.CallMethod[float64](e_, "deltaX")
	return rv
}

func (e_ Event) DeltaY() float64 {
	rv := objc.CallMethod[float64](e_, "deltaY")
	return rv
}

func (e_ Event) DeltaZ() float64 {
	rv := objc.CallMethod[float64](e_, "deltaZ")
	return rv
}

func (e_ Event) HasPreciseScrollingDeltas() bool {
	rv := objc.CallMethod[bool](e_, "hasPreciseScrollingDeltas")
	return rv
}

func (e_ Event) ScrollingDeltaX() float64 {
	rv := objc.CallMethod[float64](e_, "scrollingDeltaX")
	return rv
}

func (e_ Event) ScrollingDeltaY() float64 {
	rv := objc.CallMethod[float64](e_, "scrollingDeltaY")
	return rv
}

func (e_ Event) MomentumPhase() EventPhase {
	rv := objc.CallMethod[EventPhase](e_, "momentumPhase")
	return rv
}

func (e_ Event) IsDirectionInvertedFromDevice() bool {
	rv := objc.CallMethod[bool](e_, "isDirectionInvertedFromDevice")
	return rv
}

func (ec _EventClass) IsSwipeTrackingFromScrollEventsEnabled() bool {
	rv := objc.CallMethod[bool](ec, "isSwipeTrackingFromScrollEventsEnabled")
	return rv
}

func (e_ Event) Phase() EventPhase {
	rv := objc.CallMethod[EventPhase](e_, "phase")
	return rv
}

func (e_ Event) Magnification() float64 {
	rv := objc.CallMethod[float64](e_, "magnification")
	return rv
}

func (ec _EventClass) IsMouseCoalescingEnabled() bool {
	rv := objc.CallMethod[bool](ec, "isMouseCoalescingEnabled")
	return rv
}

func (ec _EventClass) SetMouseCoalescingEnabled(value bool) {
	objc.CallMethod[objc.Void](ec, "setMouseCoalescingEnabled:", value)
}

func (e_ Event) Pressure() float32 {
	rv := objc.CallMethod[float32](e_, "pressure")
	return rv
}

func (e_ Event) Stage() int {
	rv := objc.CallMethod[int](e_, "stage")
	return rv
}

func (e_ Event) StageTransition() float64 {
	rv := objc.CallMethod[float64](e_, "stageTransition")
	return rv
}

func (e_ Event) PressureBehavior() PressureBehavior {
	rv := objc.CallMethod[PressureBehavior](e_, "pressureBehavior")
	return rv
}

func (e_ Event) CapabilityMask() uint {
	rv := objc.CallMethod[uint](e_, "capabilityMask")
	return rv
}

func (e_ Event) DeviceID() uint {
	rv := objc.CallMethod[uint](e_, "deviceID")
	return rv
}

func (e_ Event) IsEnteringProximity() bool {
	rv := objc.CallMethod[bool](e_, "isEnteringProximity")
	return rv
}

func (e_ Event) PointingDeviceID() uint {
	rv := objc.CallMethod[uint](e_, "pointingDeviceID")
	return rv
}

func (e_ Event) PointingDeviceSerialNumber() uint {
	rv := objc.CallMethod[uint](e_, "pointingDeviceSerialNumber")
	return rv
}

func (e_ Event) PointingDeviceType() PointingDeviceType {
	rv := objc.CallMethod[PointingDeviceType](e_, "pointingDeviceType")
	return rv
}

func (e_ Event) SystemTabletID() uint {
	rv := objc.CallMethod[uint](e_, "systemTabletID")
	return rv
}

func (e_ Event) TabletID() uint {
	rv := objc.CallMethod[uint](e_, "tabletID")
	return rv
}

func (e_ Event) UniqueID() uint64 {
	rv := objc.CallMethod[uint64](e_, "uniqueID")
	return rv
}

func (e_ Event) VendorID() uint {
	rv := objc.CallMethod[uint](e_, "vendorID")
	return rv
}

func (e_ Event) VendorPointingDeviceType() uint {
	rv := objc.CallMethod[uint](e_, "vendorPointingDeviceType")
	return rv
}

func (e_ Event) AbsoluteX() int {
	rv := objc.CallMethod[int](e_, "absoluteX")
	return rv
}

func (e_ Event) AbsoluteY() int {
	rv := objc.CallMethod[int](e_, "absoluteY")
	return rv
}

func (e_ Event) AbsoluteZ() int {
	rv := objc.CallMethod[int](e_, "absoluteZ")
	return rv
}

func (e_ Event) ButtonMask() EventButtonMask {
	rv := objc.CallMethod[EventButtonMask](e_, "buttonMask")
	return rv
}

func (e_ Event) Rotation() float32 {
	rv := objc.CallMethod[float32](e_, "rotation")
	return rv
}

func (e_ Event) TangentialPressure() float32 {
	rv := objc.CallMethod[float32](e_, "tangentialPressure")
	return rv
}

func (e_ Event) Tilt() foundation.Point {
	rv := objc.CallMethod[foundation.Point](e_, "tilt")
	return rv
}

func (e_ Event) VendorDefined() objc.Object {
	rv := objc.CallMethod[objc.Object](e_, "vendorDefined")
	return rv
}

func (e_ Event) EventNumber() int {
	rv := objc.CallMethod[int](e_, "eventNumber")
	return rv
}

func (e_ Event) TrackingNumber() int {
	rv := objc.CallMethod[int](e_, "trackingNumber")
	return rv
}

func (e_ Event) TrackingArea() TrackingArea {
	rv := objc.CallMethod[TrackingArea](e_, "trackingArea")
	return rv
}

func (e_ Event) UserData() unsafe.Pointer {
	rv := objc.CallMethod[unsafe.Pointer](e_, "userData")
	return rv
}

func (e_ Event) Data1() int {
	rv := objc.CallMethod[int](e_, "data1")
	return rv
}

func (e_ Event) Data2() int {
	rv := objc.CallMethod[int](e_, "data2")
	return rv
}

// deprecated
func (e_ Event) Context() GraphicsContext {
	rv := objc.CallMethod[GraphicsContext](e_, "context")
	return rv
}
